...
class _OSState extends State<OS> {
  ...
  Future loadFuncionarios() async {
    Response response;
    Dio dio = new Dio();
    String url = 'http://192.168.0.142:8090/api/funcionarios';
                              ...
                              ElevatedButton(
                                ...
                                onPressed: () async {
                                  if (_numeroOsController.text.isEmpty) {
                                    ...
                                    Dio dio = new Dio();
                                    String url =
                                        'http://192.168.0.142:8090/api/getOs';
                                        ...
                                        actions: <Widget>[
                                          ...
                                          new FlatButton(
                                              ...
                                              onPressed: () async {
                                                ...
                                                Dio dio = new Dio();
                                                String url =
                                                    'http://192.168.0.142:8090/api/deleteProduto';
                                                response =
                    ...
                    Expanded(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          Response response;
                          Dio dio = new Dio();
                          String url = 'http://192.168.0.142:8090/api/getPeca';
                          response = await dio.post(url,
                            ...
                            onPressed: (_qtdController.text.isEmpty ||
                                ...
                                : () async {
                                    if ((nivelUsuario == "MASTER" ||
                                      ...
                                      Dio dio = new Dio();
                                      String url =
                                          'http://192.168.0.142:8090/api/addProduto';
                                      response = await dio.post(url, data: {
                                        "CodOs": osCod,
                                      ...
                                      if (response.data == "Ok!") {
                                        ...
                                        Dio dio = new Dio();
                                        String url =
                                            'http://192.168.0.142:8090/api/updateCusto';
                                        ...
                                        Dio dio = new Dio();
                                        String url =
                                            'http://192.168.0.142:8090/api/updateProduto';
                                        response = await dio.post(url, data: {
                                          "CodOs": osCod,
                                          "CodProduto": produtoCod,
                                          "Qtde": _qtdController.text,
